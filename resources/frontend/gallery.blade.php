                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Sport</a>
                                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Event</a>  
                            </div>
                        </div>
                            ...
                            <div class="product-content">
                                <div class="product-image-content">
                                            <div class="product-image">
                                                <img class="img-fluid" id="myImage" src="{{ asset('img/gallary/gal2.jpg') }}" alt="">
                                            </div>
                                            
                                    <div class="product-image-slider">
                                        <div id="sync2" class="owl-carousel owl-theme">       
                                            <div class="item">
                                                <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImage').src='{{ asset('img/gallary/gal2.jpg') }}'">
                                                    <img class="img-fluid" src="{{ asset('img/gallary/gal2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="item">
                                                <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImage').src='{{ asset('img/gallary/gal1.jpg') }}'">
                                                    <img class="img-fluid" src="{{ asset('img/gallary/gal1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="item">
                                                <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImage').src='{{ asset('img/gallary/gal3.jpg') }}'">
                                                    <img class="img-fluid" src="{{ asset('img/gallary/gal3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="item">
                                                <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImage').src='{{ asset('img/gallary/gal4.jpg') }}'">
                                                    <img class="img-fluid" src="{{ asset('img/gallary/gal4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                    ...
                                    <div class="product-content">
                                        <div class="product-image-content">
                                                    <div class="product-image">
                                                        <img class="img-fluid" id="myImageevent" src="{{ asset('img/gallary/gal7.jpg') }}" alt="">
                                                    </div>
                                                    
                                            <div class="product-image-slider">
                                                <div id="sync2" class="sync2event owl-carousel owl-theme">       
                                                    <div class="item">
                                                        <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImageevent').src='{{ asset('img/gallary/gal7.jpg') }}'">
                                                            <img class="img-fluid" src="{{ asset('img/gallary/gal7.jpg') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImageevent').src='{{ asset('img/gallary/gal6.jpg') }}'">
                                                            <img class="img-fluid" src="{{ asset('img/gallary/gal6.jpg') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImageevent').src='{{ asset('img/gallary/gal5.jpg') }}'">
                                                            <img class="img-fluid" src="{{ asset('img/gallary/gal5.jpg') }}" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="item">
                                                        <a href="javascript:void(0)" class="item" onclick="document.getElementById('myImageevent').src='{{ asset('img/gallary/gal4.jpg') }}'">
                                                            <img class="img-fluid" src="{{ asset('img/gallary/gal4.jpg') }}" alt="">
                                                        </a>
                                                    </div>
                                                </div>
