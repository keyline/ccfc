                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="project-item">
                                            <div class="gallery">
                                                <a href="{{ asset('img/activities/right_sideimage_1.jpg') }}" class="item-inner" data-fancybox="image">
                                                    <div class="item-img">
                                        ...
                                        <div class="project-item">
                                            <div class="gallery">
                                                <a href="{{ asset('img/activities/right_sideimage_2.jpg') }}" class="item-inner" data-fancybox="image">
                                                    <div class="item-img">
