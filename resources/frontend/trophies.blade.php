                    ...
                    <div class="row">
                        <div class="trophies-tablist">  
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="year1992" role="tabpanel" aria-labelledby="year1992-tab">  
                                    <div class="trophies_tab_content_section">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6 col-lg-3 px-2 mb-3">
                                                <div class="trophy_tabcontent_inner">
                                                    <div class="trophy_tab_ceibity-img">
                                                        <a href="#" data-toggle="modal" data-target="#year1992_1"><img src="{{ asset('img/trophy/t-img1.jpg') }}" alt=""/></a>
                                                    </div>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-3 px-2 mb-3">
                                                <div class="trophy_tabcontent_inner">
                                                    <div class="trophy_tab_ceibity-img">
                                                        <a href="#" data-toggle="modal" data-target="#year1992_2"><img src="{{ asset('img/trophy/t-img2.jpg') }}" alt=""/></a>
                                                    </div>
                                                    <div class="trophy_player">
                                                        <h3>Champion</h3>
                                                        <h4>1993 - February</h4>
