    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-memberNameCommitteeNames">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.committeeName.fields.member_name') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($committeeNames as $key => $committeeName)
                            <tr data-entry-id="{{ $committeeName->id }}">
                                ...
                                <td>
                                    {{ $committeeName->member_name->name ?? '' }}
                                </td>
                                <td>
                                    {{ $committeeName->member_name->email ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-memberNameCommitteeNames:not(.ajaxTable)').DataTable({ buttons: dtButtons })
