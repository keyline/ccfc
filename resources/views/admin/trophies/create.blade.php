...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.trophy.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.trophies.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="trophy">{{ trans('cruds.trophy.fields.trophy') }}</label>
                <input class="form-control {{ $errors->has('trophy') ? 'is-invalid' : '' }}" type="text" name="trophy" id="trophy" value="{{ old('trophy', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('trophy_description') ? 'is-invalid' : '' }}" name="trophy_description" id="trophy_description">{!! old('trophy_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_award') ? 'is-invalid' : '' }}" type="text" name="year_of_award" id="year_of_award" value="{{ old('year_of_award', '') }}">
			...
			<div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_month') ? 'is-invalid' : '' }}" type="text" name="year_of_month" id="year_of_month" value="{{ old('year_of_month', '') }}">
