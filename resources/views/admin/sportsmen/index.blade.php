                    ...
                    <tr data-entry-id="{{ $sportsman->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-primary"
                                href="{{ route('admin.sportsmen.show', $sportsman->id) }}">
                                {{ trans('global.view') }}
                            </a>
                            @endcan
                            ...
                            <form action="{{ route('admin.sportsmen.destroy', $sportsman->id) }}" method="POST"
...
$(function() {
    ...
    let table = $('.datatable-Sportsman:not(.ajaxTable)').DataTable({
        buttons: dtButtons
    })
