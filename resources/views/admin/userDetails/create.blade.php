    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-details.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user_code') ? 'is-invalid' : '' }}" name="user_code_id" id="user_code_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_type_code') ? 'is-invalid' : '' }}" type="text" name="member_type_code" id="member_type_code" value="{{ old('member_type_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_type') ? 'is-invalid' : '' }}" type="text" name="member_type" id="member_type" value="{{ old('member_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_since') ? 'is-invalid' : '' }}" type="text" name="member_since" id="member_since" value="{{ old('member_since', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('represented_club_in') ? 'is-invalid' : '' }}" type="text" name="represented_club_in" id="represented_club_in" value="{{ old('represented_club_in', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hobbies_interest') ? 'is-invalid' : '' }}" type="text" name="hobbies_interest" id="hobbies_interest" value="{{ old('hobbies_interest', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_profession') ? 'is-invalid' : '' }}" type="text" name="business_profession" id="business_profession" value="{{ old('business_profession', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_1') ? 'is-invalid' : '' }}" type="text" name="business_address_1" id="business_address_1" value="{{ old('business_address_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_2') ? 'is-invalid' : '' }}" type="text" name="business_address_2" id="business_address_2" value="{{ old('business_address_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_3') ? 'is-invalid' : '' }}" type="text" name="business_address_3" id="business_address_3" value="{{ old('business_address_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_city') ? 'is-invalid' : '' }}" type="text" name="business_city" id="business_city" value="{{ old('business_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_state') ? 'is-invalid' : '' }}" type="text" name="business_state" id="business_state" value="{{ old('business_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_pin') ? 'is-invalid' : '' }}" type="text" name="business_pin" id="business_pin" value="{{ old('business_pin', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_phone_1') ? 'is-invalid' : '' }}" type="text" name="business_phone_1" id="business_phone_1" value="{{ old('business_phone_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_phone_2') ? 'is-invalid' : '' }}" type="text" name="business_phone_2" id="business_phone_2" value="{{ old('business_phone_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_email') ? 'is-invalid' : '' }}" type="text" name="business_email" id="business_email" value="{{ old('business_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('spouse_dob') ? 'is-invalid' : '' }}" type="text" name="spouse_dob" id="spouse_dob" value="{{ old('spouse_dob') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\UserDetail::SPOUSE_SEX_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('spouse_sex') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="spouse_sex_{{ $key }}" name="spouse_sex" value="{{ $key }}" {{ old('spouse_sex', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_phone_1') ? 'is-invalid' : '' }}" type="text" name="spouse_phone_1" id="spouse_phone_1" value="{{ old('spouse_phone_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_phone_2') ? 'is-invalid' : '' }}" type="text" name="spouse_phone_2" id="spouse_phone_2" value="{{ old('spouse_phone_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_email') ? 'is-invalid' : '' }}" type="text" name="spouse_email" id="spouse_email" value="{{ old('spouse_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('anniversary_date') ? 'is-invalid' : '' }}" type="text" name="anniversary_date" id="anniversary_date" value="{{ old('anniversary_date') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_profession">{{ trans('cruds.userDetail.fields.spouse_business_profession') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_profession') ? 'is-invalid' : '' }}" type="text" name="spouse_business_profession" id="spouse_business_profession" value="{{ old('spouse_business_profession', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_category">{{ trans('cruds.userDetail.fields.spouse_business_category') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_category') ? 'is-invalid' : '' }}" type="text" name="spouse_business_category" id="spouse_business_category" value="{{ old('spouse_business_category', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_address_1">{{ trans('cruds.userDetail.fields.spouse_business_address_1') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_address_1') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_1" id="spouse_business_address_1" value="{{ old('spouse_business_address_1', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_address_2">{{ trans('cruds.userDetail.fields.spouse_business_address_2') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_address_2') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_2" id="spouse_business_address_2" value="{{ old('spouse_business_address_2', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_address_3">{{ trans('cruds.userDetail.fields.spouse_business_address_3') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_address_3') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_3" id="spouse_business_address_3" value="{{ old('spouse_business_address_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_city') ? 'is-invalid' : '' }}" type="text" name="spouse_business_city" id="spouse_business_city" value="{{ old('spouse_business_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_state') ? 'is-invalid' : '' }}" type="text" name="spouse_business_state" id="spouse_business_state" value="{{ old('spouse_business_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_pin') ? 'is-invalid' : '' }}" type="text" name="spouse_business_pin" id="spouse_business_pin" value="{{ old('spouse_business_pin', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_phone_1">{{ trans('cruds.userDetail.fields.spouse_business_phone_1') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_phone_1') ? 'is-invalid' : '' }}" type="text" name="spouse_business_phone_1" id="spouse_business_phone_1" value="{{ old('spouse_business_phone_1', '') }}">
            ...
            <div class="form-group">
                <label for="spouse_business_phone_2">{{ trans('cruds.userDetail.fields.spouse_business_phone_2') }}</label>
                <input class="form-control {{ $errors->has('spouse_business_phone_2') ? 'is-invalid' : '' }}" type="text" name="spouse_business_phone_2" id="spouse_business_phone_2" value="{{ old('spouse_business_phone_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_email') ? 'is-invalid' : '' }}" type="text" name="spouse_business_email" id="spouse_business_email" value="{{ old('spouse_business_email', '') }}">
            ...
            <div class="form-group">
                ...
                <div class="needsclick dropzone {{ $errors->has('spouse_image') ? 'is-invalid' : '' }}" id="spouse_image-dropzone">
                </div>
...
@if(isset($userDetail) && $userDetail->member_image)
      var file = {!! json_encode($userDetail->member_image) !!}
...
@if(isset($userDetail) && $userDetail->spouse_image)
      var file = {!! json_encode($userDetail->spouse_image) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview)
      file.previewElement.classList.add('dz-complete')
