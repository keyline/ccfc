    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-details.update", [$userDetail->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hobbies_interest') ? 'is-invalid' : '' }}" type="text" name="hobbies_interest" id="hobbies_interest" value="{{ old('hobbies_interest', $userDetail->hobbies_interest) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_profession') ? 'is-invalid' : '' }}" type="text" name="business_profession" id="business_profession" value="{{ old('business_profession', $userDetail->business_profession) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $userDetail->category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_1') ? 'is-invalid' : '' }}" type="text" name="business_address_1" id="business_address_1" value="{{ old('business_address_1', $userDetail->business_address_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_2') ? 'is-invalid' : '' }}" type="text" name="business_address_2" id="business_address_2" value="{{ old('business_address_2', $userDetail->business_address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_address_3') ? 'is-invalid' : '' }}" type="text" name="business_address_3" id="business_address_3" value="{{ old('business_address_3', $userDetail->business_address_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_city') ? 'is-invalid' : '' }}" type="text" name="business_city" id="business_city" value="{{ old('business_city', $userDetail->business_city) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_state') ? 'is-invalid' : '' }}" type="text" name="business_state" id="business_state" value="{{ old('business_state', $userDetail->business_state) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_pin') ? 'is-invalid' : '' }}" type="text" name="business_pin" id="business_pin" value="{{ old('business_pin', $userDetail->business_pin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_phone_1') ? 'is-invalid' : '' }}" type="text" name="business_phone_1" id="business_phone_1" value="{{ old('business_phone_1', $userDetail->business_phone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_phone_2') ? 'is-invalid' : '' }}" type="text" name="business_phone_2" id="business_phone_2" value="{{ old('business_phone_2', $userDetail->business_phone_2) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\UserDetail::SPOUSE_SEX_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('spouse_sex') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="spouse_sex_{{ $key }}" name="spouse_sex" value="{{ $key }}" {{ old('spouse_sex', $userDetail->spouse_sex) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_phone_1') ? 'is-invalid' : '' }}" type="text" name="spouse_phone_1" id="spouse_phone_1" value="{{ old('spouse_phone_1', $userDetail->spouse_phone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_phone_2') ? 'is-invalid' : '' }}" type="text" name="spouse_phone_2" id="spouse_phone_2" value="{{ old('spouse_phone_2', $userDetail->spouse_phone_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_email') ? 'is-invalid' : '' }}" type="text" name="spouse_email" id="spouse_email" value="{{ old('spouse_email', $userDetail->spouse_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_profession') ? 'is-invalid' : '' }}" type="text" name="spouse_business_profession" id="spouse_business_profession" value="{{ old('spouse_business_profession', $userDetail->spouse_business_profession) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_category') ? 'is-invalid' : '' }}" type="text" name="spouse_business_category" id="spouse_business_category" value="{{ old('spouse_business_category', $userDetail->spouse_business_category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_address_1') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_1" id="spouse_business_address_1" value="{{ old('spouse_business_address_1', $userDetail->spouse_business_address_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_address_2') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_2" id="spouse_business_address_2" value="{{ old('spouse_business_address_2', $userDetail->spouse_business_address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_address_3') ? 'is-invalid' : '' }}" type="text" name="spouse_business_address_3" id="spouse_business_address_3" value="{{ old('spouse_business_address_3', $userDetail->spouse_business_address_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_city') ? 'is-invalid' : '' }}" type="text" name="spouse_business_city" id="spouse_business_city" value="{{ old('spouse_business_city', $userDetail->spouse_business_city) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_state') ? 'is-invalid' : '' }}" type="text" name="spouse_business_state" id="spouse_business_state" value="{{ old('spouse_business_state', $userDetail->spouse_business_state) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_pin') ? 'is-invalid' : '' }}" type="text" name="spouse_business_pin" id="spouse_business_pin" value="{{ old('spouse_business_pin', $userDetail->spouse_business_pin) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_phone_1') ? 'is-invalid' : '' }}" type="text" name="spouse_business_phone_1" id="spouse_business_phone_1" value="{{ old('spouse_business_phone_1', $userDetail->spouse_business_phone_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_phone_2') ? 'is-invalid' : '' }}" type="text" name="spouse_business_phone_2" id="spouse_business_phone_2" value="{{ old('spouse_business_phone_2', $userDetail->spouse_business_phone_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_business_email') ? 'is-invalid' : '' }}" type="text" name="spouse_business_email" id="spouse_business_email" value="{{ old('spouse_business_email', $userDetail->spouse_business_email) }}">
