    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.news.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('news_title') ? 'is-invalid' : '' }}" type="text" name="news_title" id="news_title" value="{{ old('news_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('news_details') ? 'is-invalid' : '' }}" name="news_details" id="news_details">{!! old('news_details') !!}</textarea>
