    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reciprocal-clubs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reciprocal_club_name') ? 'is-invalid' : '' }}" type="text" name="reciprocal_club_name" id="reciprocal_club_name" value="{{ old('reciprocal_club_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReciprocalClub::CUB_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cub_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cub_type_{{ $key }}" name="cub_type" value="{{ $key }}" {{ old('cub_type', '') === (string) $key ? 'checked' : '' }} required>
