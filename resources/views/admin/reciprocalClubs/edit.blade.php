...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.reciprocalClub.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.reciprocal-clubs.update", [$reciprocalClub->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="reciprocal_club_name">{{ trans('cruds.reciprocalClub.fields.reciprocal_club_name') }}</label>
                <input class="form-control {{ $errors->has('reciprocal_club_name') ? 'is-invalid' : '' }}" type="text" name="reciprocal_club_name" id="reciprocal_club_name" value="{{ old('reciprocal_club_name', $reciprocalClub->reciprocal_club_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_1') ? 'is-invalid' : '' }}" type="text" name="address_1" id="address_1" value="{{ old('address_1', $reciprocalClub->address_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_2') ? 'is-invalid' : '' }}" type="text" name="address_2" id="address_2" value="{{ old('address_2', $reciprocalClub->address_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $reciprocalClub->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $reciprocalClub->email) }}">
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $reciprocalClub->website) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details" id="details">{!! old('details', $reciprocalClub->details) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ReciprocalClub::CUB_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('cub_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="cub_type_{{ $key }}" name="cub_type" value="{{ $key }}" {{ old('cub_type', $reciprocalClub->cub_type) === (string) $key ? 'checked' : '' }} required>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('admin.reciprocal-clubs.storeCKEditorImages') }}', true);
