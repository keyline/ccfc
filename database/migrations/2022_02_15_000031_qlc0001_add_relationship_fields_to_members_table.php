...
class Qlc0001AddRelationshipFieldsToMembersTable extends Migration
{
    public function up()
    {
        Schema::table('members', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('select_sport_id')->nullable();
            $table->foreign('select_sport_id', 'select_sport_fk_5922696')->references('id')->on('sportstypes');
        });
    }
}
